...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec danawa-price-search scripts/danawa_search.py -- search "에어팟 프로 2세대" --limit 8
npx -y @nomadamas/k-skill@0.2.2 exec danawa-price-search scripts/danawa_search.py -- offers 28208783 --limit 10
npx -y @nomadamas/k-skill@0.2.2 exec danawa-price-search scripts/danawa_search.py -- compare "에어팟 프로 2세대" --limit 5 --offers 5
```
...
1. 검색어를 확인한다.
2. `npx -y @nomadamas/k-skill@0.2.2 exec danawa-price-search scripts/danawa_search.py -- search "<검색어>" --limit 5`로 후보를 확인한다.

...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec kstartup-search scripts/run_kstartup.py -- announcements \
...
# 2024년 사업화 분야 통합공고
npx -y @nomadamas/k-skill@0.2.2 exec kstartup-search scripts/run_kstartup.py -- business-info \
  --biz-yr 2024 --biz-category-cd cmrczn_Tab3 --json

# 정책·공지 최신 콘텐츠
npx -y @nomadamas/k-skill@0.2.2 exec kstartup-search scripts/run_kstartup.py -- contents \
  --clss-cd notice_matr --per-page 10 --text

# 창업기업 실태조사 통계보고서
npx -y @nomadamas/k-skill@0.2.2 exec kstartup-search scripts/run_kstartup.py -- statistics \
...
- `npx -y @nomadamas/k-skill@0.2.2 exec kstartup-search scripts/run_kstartup.py -- --help`
- `npx -y @nomadamas/k-skill@0.2.2 exec kstartup-search scripts/run_kstartup.py -- announcements --supt-regin 서울특별시 --dry-run`

...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec keris-academic-search scripts/keris_academic.py -- search --keyword '인공지능 교육'
npx -y @nomadamas/k-skill@0.2.2 exec keris-academic-search scripts/keris_academic.py -- search --title '대학도서관' --author '김연구' --resource-type T
npx -y @nomadamas/k-skill@0.2.2 exec keris-academic-search scripts/keris_academic.py -- search --keyword '한국어 교육' --resource-type D --page 2 --page-size 20 --json
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec keris-academic-search scripts/keris_academic.py -- search --keyword '교육 데이터' --resource-type ALL --dry-run
```

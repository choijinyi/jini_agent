...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec building-register-search scripts/building_register.py -- title --address '서울 강남구 역삼동 123-4'
npx -y @nomadamas/k-skill@0.2.2 exec building-register-search scripts/building_register.py -- title --pnu 1168010100101230004
npx -y @nomadamas/k-skill@0.2.2 exec building-register-search scripts/building_register.py -- title --sigungu-cd 11680 --bjdong-cd 10100 --plat-gb-cd 0 --bun 123 --ji 4
npx -y @nomadamas/k-skill@0.2.2 exec building-register-search scripts/building_register.py -- title --pnu 1168010100101230004 --json
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec building-register-search scripts/building_register.py -- title --pnu 1168010100101230004 --direct
npx -y @nomadamas/k-skill@0.2.2 exec building-register-search scripts/building_register.py -- title --pnu 1168010100101230004 --direct --dry-run
```

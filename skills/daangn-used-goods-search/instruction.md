...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec daangn-used-goods-search scripts/daangn_used_goods.py -- search "맥북" --region "합정동" --limit 5
npx -y @nomadamas/k-skill@0.2.2 exec daangn-used-goods-search scripts/daangn_used_goods.py -- detail "https://www.daangn.com/kr/buy-sell/.../"
```

...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec ev-charger-nearby scripts/ev_charger.py -- info --location '서울 강남구' --num-of-rows 10
npx -y @nomadamas/k-skill@0.2.2 exec ev-charger-nearby scripts/ev_charger.py -- status --stat-id ME000001 --num-of-rows 10
npx -y @nomadamas/k-skill@0.2.2 exec ev-charger-nearby scripts/ev_charger.py -- status --zcode 11 --limit-yn Y --period 10 --json
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec ev-charger-nearby scripts/ev_charger.py -- info --zcode 11 --zscode 11680 --direct
npx -y @nomadamas/k-skill@0.2.2 exec ev-charger-nearby scripts/ev_charger.py -- status --stat-id ME000001 --direct --dry-run
```

...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec jobkorea-talent-search scripts/jobkorea_talent_search.py --   --keyword "퍼포먼스 마케터 GA4"   --work-area "서울"   --career-min 3   --career-max 7   --limit 20
```

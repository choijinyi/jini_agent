...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec geeknews-search scripts/geeknews_search.py -- list --limit 10
```

### 2) Search the feed conservatively

```bash
npx -y @nomadamas/k-skill@0.2.2 exec geeknews-search scripts/geeknews_search.py -- search --query Claude --limit 5
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec geeknews-search scripts/geeknews_search.py -- detail --id 28439
```

...
npx -y @nomadamas/k-skill@0.2.2 exec popbill scripts/popbill_cli.py -- config-check

# 특정 SDK service method 목록과 approval 필요 여부 확인
npx -y @nomadamas/k-skill@0.2.2 exec popbill scripts/popbill_cli.py -- methods taxinvoice
npx -y @nomadamas/k-skill@0.2.2 exec popbill scripts/popbill_cli.py -- methods kakao

# 안전한 SDK 객체 템플릿 출력
npx -y @nomadamas/k-skill@0.2.2 exec popbill scripts/popbill_cli.py -- object-template taxinvoice
npx -y @nomadamas/k-skill@0.2.2 exec popbill scripts/popbill_cli.py -- object-template cashbill

# 테스트 환경에서 안전한 회원/파트너 잔액 smoke test
npx -y @nomadamas/k-skill@0.2.2 exec popbill scripts/popbill_cli.py -- health taxinvoice

# 휴폐업 단건 조회
npx -y @nomadamas/k-skill@0.2.2 exec popbill scripts/popbill_cli.py -- closedown-check --target-corp-num 123-45-67890
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec popbill scripts/popbill_cli.py -- call <service> <method> \
  --args-json '["@corp", "arg2"]' \
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec popbill scripts/popbill_cli.py -- call taxinvoice registIssue \

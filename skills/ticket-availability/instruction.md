...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec ticket-availability scripts/ticket_availability.py -- schedule "https://tickets.interpark.com/goods/26000541"
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec ticket-availability scripts/ticket_availability.py -- seats "interpark:26000541"
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec ticket-availability scripts/ticket_availability.py -- health
```

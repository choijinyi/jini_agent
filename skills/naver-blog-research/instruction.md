...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec naver-blog-research scripts/naver_search.py -- "검색어" --count 10 --sort sim
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec naver-blog-research scripts/naver_read.py -- "https://blog.naver.com/user123/224212849946"
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec naver-blog-research scripts/naver_download_images.py -- --urls "url1,url2,url3" --output ./images/
```

또는 `naver_read.py` 결과를 파이프로 전달:

```bash
npx -y @nomadamas/k-skill@0.2.2 exec naver-blog-research scripts/naver_read.py -- "https://..." | npx -y @nomadamas/k-skill@0.2.2 exec naver-blog-research scripts/naver_download_images.py -- --output ./images/
```

...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec myrealtrip-search scripts/myrealtrip_mcp.py -- tools
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec myrealtrip-search scripts/myrealtrip_mcp.py -- call searchDomesticFlights \
  --arg origin=GMP \
  --arg destination=CJU \
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec myrealtrip-search scripts/myrealtrip_mcp.py -- call searchInternationalFlights \
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec myrealtrip-search scripts/myrealtrip_mcp.py -- call flightsFareCalendar \
  --arg from=ICN \
  --arg to=NRT \
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec myrealtrip-search scripts/myrealtrip_mcp.py -- call getPromotionAirlines
```

### 4. 숙소 검색과 상세 조회

```bash
npx -y @nomadamas/k-skill@0.2.2 exec myrealtrip-search scripts/myrealtrip_mcp.py -- call searchStays \
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec myrealtrip-search scripts/myrealtrip_mcp.py -- call getStayDetail \
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec myrealtrip-search scripts/myrealtrip_mcp.py -- call getCategoryList --arg city=Osaka
```

검색어는 한국어가 가장 잘 맞는다.

```bash
npx -y @nomadamas/k-skill@0.2.2 exec myrealtrip-search scripts/myrealtrip_mcp.py -- call searchTnas \
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec myrealtrip-search scripts/myrealtrip_mcp.py -- call getTnaDetail \
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec myrealtrip-search scripts/myrealtrip_mcp.py -- call getTnaOptions \

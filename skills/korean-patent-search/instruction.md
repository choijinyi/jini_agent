...
npx -y @nomadamas/k-skill@0.2.2 exec korean-patent-search scripts/patent_search.py -- --query "배터리"
npx -y @nomadamas/k-skill@0.2.2 exec korean-patent-search scripts/patent_search.py -- --query "배터리" --year 2024 --num-rows 5
npx -y @nomadamas/k-skill@0.2.2 exec korean-patent-search scripts/patent_search.py -- --application-number 1020240001234
```

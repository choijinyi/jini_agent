...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec seoul-bike scripts/seoul_bike.py -- <subcommand> [args]
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec seoul-bike scripts/seoul_bike.py -- nearby --lat 37.5717 --lon 126.9763 --radius-m 500
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec seoul-bike scripts/seoul_bike.py -- search "광화문" --limit 5
```

...
소스별 검색 패턴은 `npx -y @nomadamas/k-skill@0.2.2 read korean-scholarship-search references/source-patterns.md` 를 보고, 검색 누락을 줄이려면 `npx -y @nomadamas/k-skill@0.2.2 read korean-scholarship-search references/search-clues.md` 의 키워드와 제목 단서를 같이 쓴다.
...
학교 완전 탐색 체크리스트는 `npx -y @nomadamas/k-skill@0.2.2 read korean-scholarship-search references/school-discovery.md` 를 본다.

학교별 search plan을 만들 때는:

```bash
npx -y @nomadamas/k-skill@0.2.2 exec korean-scholarship-search scripts/university_search_plan.py -- \
  --school-name "부산대학교" \
  --department "컴퓨터공학과" \
  --year 2026
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec korean-scholarship-search scripts/university_search_plan.py -- --nationwide --year 2026
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec korean-scholarship-search scripts/scholarship_filter.py -- filter \
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec korean-scholarship-search scripts/scholarship_filter.py -- eligibility \
  --input scholarships.json \
  --school-name "서울대학교" \
  --student-level undergraduate \
  --grade-year 2 \
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec korean-scholarship-search scripts/scholarship_filter.py -- report \
  --input scholarships.json \
  --today 2026-04-14 \
  --only-open-now \
  --school-name "서울대학교"
...
더 자세한 form 규칙은 `npx -y @nomadamas/k-skill@0.2.2 read korean-scholarship-search references/report-format.md` 를 본다.
...
- 한국장학재단 공식 장학·지원구간 표면은 `npx -y @nomadamas/k-skill@0.2.2 read korean-scholarship-search references/source-patterns.md` 참고

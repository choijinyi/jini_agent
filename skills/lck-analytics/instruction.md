...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec lck-analytics scripts/sync-oracle.js -- \
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec lck-analytics scripts/build-match-report.js -- \
  --date 2026-04-01
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec lck-analytics scripts/analyze-live-game.js -- \
  --game game-id
```

...
각 패턴은 `분류 ID · 심각도`로 표시한다. 전체 60+ 서브 패턴 표는 `npx -y @nomadamas/k-skill@0.2.2 read korean-humanizer references/ai-tell-taxonomy.md`에 있다. 아래는 한국어 AI 글에서 가장 자주, 가장 강하게 드러나는 핵심만 추렸다.

...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec kosis-stats scripts/run_kosis_stats.py -- --help
```
...
발급 절차와 호출 한도, 에러 코드 등 자세한 내용은 `npx -y @nomadamas/k-skill@0.2.2 read kosis-stats references/kosis-openapi-guide.md` 참고.
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec kosis-stats scripts/run_kosis_stats.py -- search --query "1인 가구" --text
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec kosis-stats scripts/run_kosis_stats.py -- meta --table-id DT_1JC1501 --text
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec kosis-stats scripts/run_kosis_stats.py -- explain \
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec kosis-stats scripts/run_kosis_stats.py -- data \
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec kosis-stats scripts/run_kosis_stats.py -- bigdata \
...
- `npx -y @nomadamas/k-skill@0.2.2 exec kosis-stats scripts/run_kosis_stats.py -- --help`
- `npx -y @nomadamas/k-skill@0.2.2 exec kosis-stats scripts/run_kosis_stats.py -- search --query 인구 --dry-run` (URL/파라미터 출력만)

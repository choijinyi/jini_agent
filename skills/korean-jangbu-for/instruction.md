...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec korean-jangbu-for scripts/install.sh --
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 read korean-jangbu-for scripts/upstream.pin
...
2. `npx -y @nomadamas/k-skill@0.2.2 exec korean-jangbu-for scripts/install.sh --` 로 업스트림을 dual-install 한다.

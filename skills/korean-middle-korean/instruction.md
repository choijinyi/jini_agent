...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec korean-middle-korean scripts/korean_middle_korean.js -- --text "민수는 3월 5일 학교에서 공부했다."
npx -y @nomadamas/k-skill@0.2.2 exec korean-middle-korean scripts/korean_middle_korean.js -- --text "열애설을 인정했다." --format text
cat input.txt | npx -y @nomadamas/k-skill@0.2.2 exec korean-middle-korean scripts/korean_middle_korean.js -- --stdin --format json
npx -y @nomadamas/k-skill@0.2.2 exec korean-middle-korean scripts/korean_middle_korean.js -- --file ./input.txt --format text
```
...
- `npx -y @nomadamas/k-skill@0.2.2 exec korean-middle-korean scripts/korean_middle_korean.js -- --help` 가 동작한다.

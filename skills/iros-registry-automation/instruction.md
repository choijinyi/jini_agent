...
npx -y @nomadamas/k-skill@0.2.2 exec iros-registry-automation scripts/iros_pdf_summary.py -- \
...
npx -y @nomadamas/k-skill@0.2.2 exec iros-registry-automation scripts/iros_pdf_summary.py -- 변환결과.md --from-text --out "$workdir/output"
```

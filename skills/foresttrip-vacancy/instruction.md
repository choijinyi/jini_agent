...
npx -y @nomadamas/k-skill@0.2.2 exec foresttrip-vacancy scripts/run_foresttrip_vacancy.py -- --check-deps
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec foresttrip-vacancy scripts/run_foresttrip_vacancy.py -- --all --text --dates 20260504
```

JSON 출력:

```bash
npx -y @nomadamas/k-skill@0.2.2 exec foresttrip-vacancy scripts/run_foresttrip_vacancy.py -- --all --json --dates 20260504
```

캠핑/야영만 조회:

```bash
npx -y @nomadamas/k-skill@0.2.2 exec foresttrip-vacancy scripts/run_foresttrip_vacancy.py -- --all --text --dates 20260504 --categories 02
```

특정 휴양림명으로 조회:

```bash
npx -y @nomadamas/k-skill@0.2.2 exec foresttrip-vacancy scripts/run_foresttrip_vacancy.py -- --forest-name 유명산 --text --dates 20260504
```
...
- `npx -y @nomadamas/k-skill@0.2.2 exec foresttrip-vacancy scripts/run_foresttrip_vacancy.py -- --help`
- `npx -y @nomadamas/k-skill@0.2.2 exec foresttrip-vacancy scripts/run_foresttrip_vacancy.py -- --check-deps`
- `npm run ci`

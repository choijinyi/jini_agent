...
See `npx -y @nomadamas/k-skill@0.2.2 read intercity-bus-booking references/tmoney-intercity-http-flow.md` for session-proven endpoint details and parameter examples.
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec intercity-bus-booking scripts/intercity_bus_search.py -- \
  --depart-code 0511601 \
  --arrive-code 2482701 \
  --depart-name 동서울 \
  --arrive-name 속초 \

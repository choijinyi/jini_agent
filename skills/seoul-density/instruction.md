...
npx -y @nomadamas/k-skill@0.2.2 exec seoul-density scripts/seoul_density.py -- <subcommand> [args]
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec seoul-density scripts/seoul_density.py -- match "홍대" --json
# → ["홍대 관광특구", "홍대입구역(2호선)"]
```
...
```bash
# macOS / Linux / Git-bash
npx -y @nomadamas/k-skill@0.2.2 exec seoul-density scripts/seoul_density.py -- query "강남역"
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec seoul-density scripts/seoul_density.py -- query "강남역" --json
```

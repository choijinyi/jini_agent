...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec k-skill-cleaner scripts/k_skill_cleaner.py -- \
  --skills-root . \
  --scan-default-logs \
  --days 90 \
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec k-skill-cleaner scripts/k_skill_cleaner.py -- --skills-root . --usage-json usage-counts.json --days 90
```

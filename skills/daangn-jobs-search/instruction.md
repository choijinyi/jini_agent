...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec daangn-jobs-search scripts/daangn_jobs.py -- search "카페" --region "합정동" --limit 5
npx -y @nomadamas/k-skill@0.2.2 exec daangn-jobs-search scripts/daangn_jobs.py -- detail "https://www.daangn.com/kr/jobs/.../"
```

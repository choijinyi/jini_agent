...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec korean-slang-writing scripts/slang_search.py -- --mood "긍정,유머" --context "SNS,마케팅" --safety safe --limit 5 --format json
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec korean-slang-writing scripts/slang_lookup.py -- "중꺾마" --format json
npx -y @nomadamas/k-skill@0.2.2 exec korean-slang-writing scripts/slang_lookup.py -- "https://namu.wiki/w/%EC%A4%91%EA%BA%BE%EB%A7%88" --max-length 800
```
...
```bash
# 1) 특정 유행어 뜻/메타 바로 확인
npx -y @nomadamas/k-skill@0.2.2 exec korean-slang-writing scripts/slang_search.py -- --query "갓생" --format text

# 2) 긍정 무드의 SNS 마케팅 후보 5개
npx -y @nomadamas/k-skill@0.2.2 exec korean-slang-writing scripts/slang_search.py -- --mood "긍정,유머" --context "SNS,마케팅" --safety safe --limit 5

# 3) 이용자가 지정한 커스텀 인덱스로 전환
npx -y @nomadamas/k-skill@0.2.2 exec korean-slang-writing scripts/slang_search.py -- --query "중꺾마" --index-path ~/Downloads/my-slang.json

# 4) 나무위키 원문 요약 시도
npx -y @nomadamas/k-skill@0.2.2 exec korean-slang-writing scripts/slang_lookup.py -- "럭키비키" --timeout 10 --format text
```

...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec nts-business-registration scripts/nts_business_registration.py -- status \
  --b-no 123-45-67890
```

```bash
npx -y @nomadamas/k-skill@0.2.2 exec nts-business-registration scripts/nts_business_registration.py -- validate \

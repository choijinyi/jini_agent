...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec highway-traffic-status scripts/highway_traffic.py -- traffic --route 경부 --text
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec highway-traffic-status scripts/highway_traffic.py -- cctv \

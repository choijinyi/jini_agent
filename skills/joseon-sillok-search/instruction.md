...
1. `npx -y @nomadamas/k-skill@0.2.2 exec joseon-sillok-search scripts/sillok_search.py -- --query "..."` 로 공식 검색 endpoint를 호출한다.
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec joseon-sillok-search scripts/sillok_search.py -- --query "훈민정음"
npx -y @nomadamas/k-skill@0.2.2 exec joseon-sillok-search scripts/sillok_search.py -- --query "훈민정음" --king "세종" --year 1443 --limit 3
npx -y @nomadamas/k-skill@0.2.2 exec joseon-sillok-search scripts/sillok_search.py -- --query "측우기" --king "세종실록" --limit 5
npx -y @nomadamas/k-skill@0.2.2 exec joseon-sillok-search scripts/sillok_search.py -- --query "임진왜란" --type w --limit 5
```

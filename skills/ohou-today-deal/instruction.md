...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec ohou-today-deal scripts/ohou_today_deal.py -- list --limit 10
```
...
```bash
npx -y @nomadamas/k-skill@0.2.2 exec ohou-today-deal scripts/ohou_today_deal.py -- list \
  --sort discount \
  --limit 5
```
